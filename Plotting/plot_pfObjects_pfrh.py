...
outputfile_list = ["ttbar/ttbar_pfrh.root", "SinglePiPt100_1000_n1000/PiPt_pfrh.root", "SinglePi0E100_1000_n5000/Pi0E_pfrh.root"]
...
for inputfile, outputfile in zip(inputfile_list, outputfile_list):
    ...
    #Cuts applied: cluster energy > 30GeV,  valid time values
    ...
    for event in tree:
        ...
        for cluster_idx in range(nHcal):
            ...
            if event.hcal_energy[cluster_idx] > 30:
                ...
                #to-do: after removing timing cuts
                ...
                for i in range(nHbHepfrh): 
                    ...
                    if event.hbhe_pfrh_clusterIdx[i] == cluster_idx:
                        if ((abs(event.hcal_eta[cluster_idx]) < 1.26 and event.hbhe_pfrh_time[i] != -999) and \
                            ...
                            (abs(event.hcal_eta[cluster_idx]) >= 1.26 and event.hbhe_pfrh_time[i] != -999 and \
            ...
            if event.hcal_energy[cluster_idx] > 30 and abs(event.hcal_eta[cluster_idx]) < 1.26:
                ...
                for i in range(nHbpfrh): 
                    ...
                    if event.hb_pfrh_clusterIdx[i] == cluster_idx:
                        if (event.hb_pfrh_time[i] != -999) and \
                            ((event.hb_pfrh_depth[i] == 1 and event.hb_pfrh_energy[i] > 0.6) or \
            ...
            if event.hcal_energy[cluster_idx] > 30 and abs(event.hcal_eta[cluster_idx]) >= 1.26:
                ...
                for i in range(nHepfrh): 
                    ...
                    if event.he_pfrh_clusterIdx[i] == cluster_idx:
                        ...
                        if (event.he_pfrh_time[i] != -999) and  \
                        ((event.he_pfrh_depth[i] == 1 and event.he_pfrh_energy[i] > 0.2) or \
