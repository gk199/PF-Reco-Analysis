...
h_hcal_E  = ROOT.TH1F("h_hcal_E",  "HCAL cluster energy;E [GeV];Entries", 100, 0, 4)
...
# Ecal 
ecal_energy = ROOT.TH1F("ecal_energy", "ECAL cluster energy;E [GeV];Entries", 100, 0, 200)
...
#eb rechits
eb_rechit_energy = ROOT.TH1F("eb_rechit_energy", "EB rechit energy;E [GeV];Entries", 100, 0, 200)
...
hcal_depth = ROOT.TH1F("hcal_depth", "HCAL cluster depth", 100,0,10)
...
hb_rechit_depth = ROOT.TH1F("hb_rechit_depth", "HB Rechits Depth",10,0,10)
he_rechit_depth = ROOT.TH1F("he_rechit_depth", "HE Rechits Depth",10,0,10)
hb_rechit_counts = ROOT.TH1F("hb_rechit_counts", "HB rechit count per cluster", 100, 0, 1000)
he_rechit_counts = ROOT.TH1F("he_rechit_counts", "HE rechit count per cluster", 100, 0, 1000)
