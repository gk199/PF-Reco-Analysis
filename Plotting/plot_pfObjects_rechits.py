...
outputfile_list = ["ttbar/ttbar_hcalrh.root", "SinglePiPt100_1000_n1000/PiPt_hcalrh.root", "SinglePi0E100_1000_n5000/Pi0E_hcalrh.root"]
...
for inputfile, outputfile in zip(inputfile_list, outputfile_list):
    ...
    #Cuts applied: cluster energy > 30GeV, rechits with pf cuts, valid tdc values
            ...
            if event.hcal_energy[cluster_idx] > 30:
                ...
                for i in range(nHbHeRechits): 
                    ...
                    if event.hbheRechit_clusterIdx[i] == cluster_idx:
                        if ((abs(event.hcal_eta[cluster_idx]) < 1.26 and event.hbhe_rechit_tdc[i] != 3) and \
                            ...
                            (abs(event.hcal_eta[cluster_idx]) >= 1.26 and event.hbhe_rechit_tdc[i] != 62 and event.hbhe_rechit_tdc[i] != 63 and \
            ...
            if event.hcal_energy[cluster_idx] > 30 and abs(event.hcal_eta[cluster_idx]) < 1.26:
                ...
                for i in range(nHbRechits): 
                    ...
                    if event.hb_rechit_clusterIdx[i] == cluster_idx:
                        if (event.hb_rechit_tdc[i] != 3) and \
                            ((event.hb_rechit_depth[i] == 1 and event.hb_rechit_energy[i] > 0.6) or \
            ...
            if event.hcal_energy[cluster_idx] > 30 and abs(event.hcal_eta[cluster_idx]) >= 1.26:
                ...
                for i in range(nHeRechits): 
                    ...
                    if event.he_rechit_clusterIdx[i] == cluster_idx:
                        ...
                        if (event.he_rechit_tdc[i] != 62 and event.he_rechit_tdc[i] != 63) and  \
                        ((event.he_rechit_depth[i] == 1 and event.he_rechit_energy[i] > 0.2) or \
