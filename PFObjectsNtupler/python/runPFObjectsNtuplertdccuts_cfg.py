...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/user/c/chtong/PF/CMSSW_15_0_6/src/PF-Reco-Analysis/SinglePiPt100_1000_n1000/pf_only_reReco_MC.root'
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('pfObjectsNtuple_tdc_cuts.root')
)

process.pfObjectsNtuplertdccuts = cms.EDAnalyzer("PFObjectsNtuplertdccuts",
...
process.p = cms.Path(process.pfObjectsNtuplertdccuts)